...
//Autcomplete function with list of top cities
$( function() {
    var availableCities = [
...
// Runs getWeather function with the text content of saved city li
  ...
  // function to fetch lat/lon of city and then fetch weather data and assign to proper html elements
  ...
  // Sortable function for saved city list
